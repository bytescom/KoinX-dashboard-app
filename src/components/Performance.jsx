...
const Performance = () => {
  ...
  return (
    <div className="h-full w-full p-4 sm:p-6 bg-white rounded-lg shadow-md space-y-6">
      {/* Performance Section */}
      <div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex flex-col">
            ...
            <span className=" font-medium text-center text-red-500">{formatNumber(low_24h)}</span>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <span className="text-center font-medium text-green-500">{formatNumber(high_24h)}</span>
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div  className="border-b-[1px] border-gray-200 text-sm pb-3 flex justify-between">
            <p className="text-gray-500">Bitcoin Price</p>
            <p className="font-medium">${formatNumber(current_price)}</p>
          </div>
          <div className="border-b-[1px] border-gray-200 text-sm pb-3 md:px-[1px] flex justify-between">
            <p className="text-gray-500">Market Cap</p>
            <p className="font-medium">${formatNumber(market_cap)}</p>
          </div>
          <div className="border-b-[1px] border-gray-200 text-sm pb-3 md:px-[1px] flex justify-between">
          ...
          <div className="border-b-[1px] border-gray-200 text-sm pb-3 md:px-[1px] flex justify-between">
            ...
            <p className="font-medium">{market_cap_change_percentage_24h.toFixed(2)}%</p>
          </div>
          <div className="border-b-[1px] border-gray-200 text-sm pb-3 md:px-[1px] flex justify-between">
          ...
          <div className="border-b-[1px] border-gray-200 text-sm pb-3 md:px-[1px] flex justify-between">
            ...
            <p className="font-medium">${formatNumber(total_volume)}</p>
          </div>
          <div className="border-b-[1px] border-gray-200 text-sm pb-3 md:px-[1px] flex justify-between">
            <p className="text-gray-500">Market Cap Rank</p>
            <p className="font-medium">#{market_cap_rank}</p>
          </div>
          <div className="border-b-[1px] border-gray-200 text-sm pb-3 md:px-[1px] flex justify-between">
